...
| Winter, sun never rises or even gets high enough to prevent seeing 3 stars                              | `sunrise`: "downallday"<br/> `sunset`: "downallday"<br/> `jewish_twilight_end`: "alwaysdark"<br/> `sun_now`: "down"<br/> `hebrew_date_now`: always tonight's date!                                                              |
